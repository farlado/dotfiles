...
#+begin_src sh
  conky -c $XDG_CONFIG_HOME/twm/statusbar &
#+end_src
...
*** Start ~twm~
#+begin_src sh
  exec while :; do twm -f $XDG_CONFIG_HOME/twm/twmrc; done
#+end_src
...
#+begin_src conf-space
  ...
  Function "deiconify-and-lower" { f.deiconify f.lower }
#+end_src
...
- =Button3= = Toggle iconify
#+begin_src conf-space
  Button1 = : iconmgr : f.function "deiconify-and-raise"
  Button2 = : iconmgr : f.iconify
  Button3 = : iconmgr : f.function "deiconify-and-lower"
#+end_src
...
#+begin_src conf-xdefaults
  ...
  *.font: *gohufont*medium*normal*14*
